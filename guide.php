...
<html>
   ...
   <a class="current" href="#">Guidelines</a>&nbsp;&nbsp;|&nbsp;&nbsp;
   <a href="game.php">Treasure Hunt</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
   <a href="ranking.php">Leader Board</a></div>
      <div class="bg" style="color:white;background-image: url('assets/img/darkbg.jpg')">
      <div>
...
<li style="font-weight: 700">Enter your answers in lowercase. Commas, space, fullstops matter!</li>
