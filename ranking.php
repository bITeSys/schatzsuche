...
if(pg_num_rows($result4)>0){
	...
	//echo '<tr><td><input type="text" name="info1" value="' . $row->u_name' . '"></td><td><input type="text" name="info2" value="' . $row->u_lvl . '"></td></tr>';
	echo "<tr><td style='text-align:center'>".$row->u_name."</td><td style='text-align:center'>".$row->u_lvl."</td></tr>";
    }
    echo "</table></div>";
}
